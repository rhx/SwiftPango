...
![macOS](https://github.com/rhx/SwiftPango/actions/workflows/macOS.yml/badge.svg?branch=development)
![Linux](https://github.com/rhx/SwiftPango/actions/workflows/Linux.yml/badge.svg?branch=development)
...
These Swift wrappers have been tested with pango-1.40, 1.42, 1.44, 1.46, 1.48, 1.50, 1.56, and 1.58 as well as harfbuzz-4.2 and later, and glib-2.56, 2.58, 2.60, 2.62, 2.64, 2.66, 2.68, 2.70, 2.72, 2.74, 2.76, 2.86, 2.88, and 2.90.  They should work with higher versions, but YMMV.  Also make sure you have `gobject-introspection` and its `.gir` files installed.

#### Linux

##### Ubuntu

On Ubuntu 26.04, 24.04, and 22.04, you can use the pango that comes with the distribution.  Just install with the `apt` package manager:

	sudo apt update
	sudo apt install libpango1.0-dev gir1.2-pango-1.0 libcairo2-dev libharfbuzz-dev gir1.2-harfbuzz-0.0 gobject-introspection libgirepository1.0-dev libxml2-dev jq
