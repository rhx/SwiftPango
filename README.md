...
These Swift wrappers have been tested with pango-1.40, 1.42, 1.44, 1.46, 1.48, 1.50, and 1.56 as well as harfbuzz-4.2 and later, and glib-2.56, 2.58, 2.60, 2.62, 2.64, 2.66, 2.68, 2.70, 2.72, 2.74, 2.76, and 2.86.  They should work with higher versions, but YMMV.  Also make sure you have `gobject-introspection` and its `.gir` files installed.
